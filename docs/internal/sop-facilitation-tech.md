...
This document exists to teach facilitators how to do technical tasks associated with
facilitation. It also tentatively proposes potential "facilitator" roles on
